...
This action updates the Algolia search index by scraping the live [docs.fueldev.xyz](http://docs.fueldev.xyz) site. It only runs when a Fuel contributor manually runs it.
